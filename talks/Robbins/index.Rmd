---
title: "Steve Robbins youtube slides 71"
subtitle: "Bergson and the Holographic Theory of Mind"
...
# Steve Robbins Youtube lesson 71

```{r, echo = FALSE}
embed_youtube("TYn7BPek6ok")
```
...
# Zwaag, Noord Holland in The Netherlands

```{r out.width='100%', fig.height=6, eval=require('leaflet')}
library(leaflet)
leaflet() %>% addTiles() %>% setView(5.0666664, 52.666664, zoom = 17)
```
...
```{r out.width='100%', fig.height=6, eval=require('leaflet')}
library(leaflet)
leaflet() %>% addTiles() %>% setView(-8.411540, 43.362343, zoom = 17)
```
